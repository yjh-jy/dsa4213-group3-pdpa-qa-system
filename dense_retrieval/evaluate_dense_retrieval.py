...
"""
evaluate_dense_retrieval.py — Comprehensive evaluation of dense retrieval system
...
class RetrievalEvaluator:
    def __init__(self, qa_dataset_path: Path, retriever: DenseRetriever):
        """Initialize evaluator with QA dataset and retriever."""
    ...
    def evaluate_dataset(self, top_k: int = 10, max_queries: int = None) -> Dict:
        ...
        print(f"Starting evaluation with top_k={top_k}")
        ...
        for i, qa_item in enumerate(queries_to_eval):
            ...
            result = self.evaluate_single_query(qa_item, top_k)
        ...
        return {
            ...
            "dataset_info": {
                ...
                "top_k": top_k,
                "model": self.retriever.meta["model"],
    ...
    def print_evaluation_summary(self, evaluation_result: Dict):
        ...
        print("\n" + "="*60)
        print("DENSE RETRIEVAL EVALUATION SUMMARY")
        print("="*60)
        ...
        # Print key metrics
        key_metrics = ["recall@1", "recall@5", "recall@10", "precision@1", "precision@5", "precision@10", 
...
def main():
    ...
    evaluator = RetrievalEvaluator(qa_dataset_path, retriever)
    
    # Run evaluation
    print("Running evaluation...")
    evaluation_result = evaluator.evaluate_dataset(top_k=10, max_queries=None)
    ...
    output_path = results_dir / f"dense_retrieval_eval_{date_str}.json"
